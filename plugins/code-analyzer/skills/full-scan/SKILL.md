...
| 章节 | 链接 | 快速跳转 |
|------|------|----------|
| 项目概览 | [#1-项目概览](#1-项目概览) | [↓ 跳转到此章节](#1-项目概览) |
| 模块分布 | [#2-模块分布](#2-模块分布) | [↓ 跳转到此章节](#2-模块分布) |
| 模块层级图 | [#3-模块层级图](#3-模块层级图) | [↓ 跳转到此章节](#3-模块层级图) |
| 宏观依赖方向 | [#4-宏观依赖方向](#4-宏观依赖方向) | [↓ 跳转到此章节](#4-宏观依赖方向) |
| 引擎级流程概览 | [#5-引擎级流程概览](#5-引擎级流程概览) | [↓ 跳转到此章节](#5-引擎级流程概览) |
| 架构健康度 | [#6-架构健康度快照](#6-架构健康度快照) | [↓ 跳转到此章节](#6-架构健康度快照) |
| 后续建议 | [#7-后续分析建议](#7-后续分析建议) | [↓ 跳转到此章节](#7-后续分析建议) |
